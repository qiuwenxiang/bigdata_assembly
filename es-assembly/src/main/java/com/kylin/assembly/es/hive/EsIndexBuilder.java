package com.kylin.assembly.es.hive;

import com.kylin.assembly.es.EsClient;
...
public class EsIndexBuilder
{
     ...
     * @param type
     */
    public void buliderEsIndex(Map<String, String> map, String index, String type) throws IOException
    {
        ...
        System.out.println(esMapping.string());
            ...
            if (map != null && map.size() > 0)
            {
                for (Map.Entry<String, String> entry : map.entrySet())
                {
                    ...
                    } else
                    {
                        ...
                        mapBuilder.startObject(entry.getKey()).field("type", type).field("store", true).endObject();
                    }
